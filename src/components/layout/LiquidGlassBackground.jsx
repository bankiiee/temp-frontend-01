 ...
 */
const LiquidGlassBackground = ({ children, variant = 'default' }) => {
  const variants = {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className={`fixed inset-0 bg-gradient-to-br ${variants[variant]}`}>
        {/* Floating Glass Orbs */}
      ...
      {/* Overlay Effect */}
      <div className="fixed inset-0 bg-gradient-to-tr from-transparent via-white/10 to-web-green-200/20 backdrop-blur-[1px]"></div>
